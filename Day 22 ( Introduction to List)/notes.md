...
List comprehensions are used for creating new lists from other iterables like lists, tuples, dictionaries, sets, and even in arrays and strings.
 ...
 3. Iterable: It can be list, tuples, dictionaries, sets, and even in arrays and strings.
 4. Condition: Condition checks if the item should be added to the new list or not.
